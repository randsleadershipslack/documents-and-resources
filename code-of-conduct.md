...
- [The Long Version](#the-long-version)
  ...
  * [Not For Promotion (Mostly)](#not-for-promotion-mostly)
...
Be respectful of others, ask people to stop if you are bothered, respect privacy, understand this community is primarily not-for-self-promotion, and attempt to resolve issues without Administrators. However, if you can't resolve an issue, you can contact the Administrators.
...
If you want to disclose any content from a public channel outside this community, including submission to LLMs, we use a modified version of the [Chatham House Rule](https://www.chathamhouse.org/about/chatham-house-rule) as a guideline: members are free to use information received from public channels, but the individual source of the information may not be revealed.
...
Once onboard, you will likely find yourself in a popular channel with many members who sound like we've figured it out. We haven't. While advice on one channel might read as definitive, it is one member's lessons, interpretation, and learning from their leadership experience. While there is a diverse set of experiences within this community, we continue to learn at every level of expertise. The daily practice of leadership is more art than science.
...
## Not For Promotion (Mostly)

This community is hyper-allergic to unwanted promotional and/or commercial behavior. If you join this community to take value rather than contribute, the community will quickly notice and react.

Obvious promotional activities such as recruiting, lead generation, marketing, and other solicitation are prohibited except in channels dedicated to that purpose. This includes starting market research conversations outside of [\#market-research](https://rands-leadership.slack.com/archives/C03BHP3TSCW).

While obvious commercial behavior is easy to identify, non-obvious promotional behavior is a grey area. For example, linking your blog or podcast other content you've created or want input on may be interpreted as self-promotional in some channels. 

This is not LinkedIn. If your self-promotional post is designed to be clickbait, reads like an ad, or is otherwise obviously generated by robots, the community will tell you.

If you are wondering if a post is appropriate, our guidelines are that you:

* Ask permission from the channel before posting a message that might be considered promotional, stating clear intent for the post, and,
* Listen to the response of your peers in the channel and act accordingly.

If, after engaging with the community, you are still wondering if a specific message is promotional or not, please ask in one of the channels dedicated to helping you find your way in this community, such as [\#how-to-rls](https://rands-leadership.slack.com/archives/C6M7U8DFF), [\#rls-admins](https://rands-leadership.slack.com/archives/CQC5BGPAB), or [\#rls-rules](https://rands-leadership.slack.com/archives/C0GH4MMNU).

As this community grows, our tolerance for unsolicited commercial and promotional behavior decreases.
...
### Approved Commercial/Promotional Channels

On-topic and relevant commercial and self-promotional activity is allowed in these channels:
...
Some geographically focused channels have a higher tolerance for specific kinds of promotional activity focused on events based in that region. Again, read the room. If you'd like approval for a channel to be listed as promotional, please get in touch with the [Administrators](\#administrators).

❗:

* In channels where promotional activity is allowed, it is just as unwelcome to post an unrelated promotional offering as it is to post in non-promotional channels.
* Solicited requests via direct messages ("DM") without prior and apparent consent from the receiver are prohibited.
...
Administrators serve one-year terms and are given the opportunity to serve a new term each November. There is no limit to the number of terms an admin can serve.
